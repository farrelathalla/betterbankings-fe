...
export default function RateComparisonPage() {
  const { user } = useAuth();
  const [activeTab, setActiveTab] = useState("RateComparisonIDR");
  ...
  const tabLabels: Record<string, string> = {
    RateComparisonIDR: "IDR",
    RateComparisonUSD: "USD",
    RateComparisonIDRKBMI: "IDR KBMI",
    RateComparisonUSDKBMI: "USD KBMI",
  };
      ...
      <main className="w-full flex-1 lg:pl-[280px] min-h-screen">
        ...
        <div className="relative z-10 px-4 lg:px-8 py-4 pt-24">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-4 ">
            <div>
              ...
              <p className="text-gray-500 text-sm">
                Explore rate comparison data, trends, and key performance
                indicators
              </p>
            </div>
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-[#E1E7EF] p-2 overflow-hidden relative">
            ...
            <RestrictedViz isFirstTab={activeTab === "RateComparisonIDR"}>
              <div
                ref={containerRef}
