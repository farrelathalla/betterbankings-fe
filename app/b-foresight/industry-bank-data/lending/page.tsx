      ...
      <main className="w-full flex-1 lg:pl-[280px] min-h-screen">
        ...
        <div className="relative z-10 px-4 lg:px-8 py-4 pt-24">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-4 ">
            <div>
              <h1 className="text-2xl lg:text-3xl font-bold text-[#14213D]">
                Lending <span className="text-[#F48C25]">Dashboard</span>
              </h1>
              <p className="text-gray-500 text-sm">
                Explore lending data, trends, and key performance indicators
              </p>
            </div>
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-[#E1E7EF] p-2 overflow-hidden relative">
            ...
            <RestrictedViz
              isFirstTab={activeTab === "LendingOutstandingSector"}
            >
              <div
                ref={containerRef}
          ...
          {/* Analysis Box */}
          <AnalysisBox page="industry/lending" tabKey={activeTab} />
        </div>
      </main>
    </div>
  );
